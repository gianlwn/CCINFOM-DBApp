...
?>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
        ...
        <input type="number" name="category_id" min="1001" max="1999" requiredoninput="this.setCustomValidity('')"oninvalid="this.setCustomValidity('Category ID must be between 1001 and 1999.')"><br><br>

        <label>Price:</label><br>
        <input type="number" name="price" step="0.01" min="0.01" requiredoninput="this.setCustomValidity('')"oninvalid="this.setCustomValidity(this.validity.valueMissing ? 'Please enter a price.' : 'Price must be at least 0.01.')"><br><br>

        <label>Quantity in Stock:</label><br>
        <input type="number" name="quantity_in_stock" min="0" requiredoninput="this.setCustomValidity('')"oninvalid="this.setCustomValidity(this.validity.valueMissing ? 'Please enter a quantity.' : 'Value must be greater than or equal to 0.')"><br><br>

        <label>Supplier ID:</label><br>
        <input type="number" name="supplier_id" min="2001" max="2999" requiredoninput="this.setCustomValidity('')"oninvalid="this.setCustomValidity('Supplier ID must be between 2001 and 2999.')"><br><br>
