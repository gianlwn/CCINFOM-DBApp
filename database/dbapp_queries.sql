...
-- alter commands for primary keys --
...
ALTER TABLE products MODIFY product_id INT NOT NULL AUTO_INCREMENT;
ALTER TABLE products auto_increment = 3001;

ALTER TABLE suppliers MODIFY supplier_id INT NOT NULL AUTO_INCREMENT;
ALTER TABLE suppliers auto_increment = 2001;
